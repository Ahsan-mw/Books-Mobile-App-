          ...
          child: Padding(
            ...
            child: Center(
              child: Column(
                ...
                children: [
                  Text("Verification Email",style: Theme.of(context).textTheme.headlineMedium,),
                  SizedBox(
                    height: AppSizes.spaceBtwItems,

                  ),
                  Text("Please enter the code we just sent to email",style: Theme.of(context).textTheme.titleLarge!.copyWith(
                    color: AppColors.textLightGreyColor
                  ),),
                  SizedBox(
                    height: AppSizes.spaceBtwItems,
                  ),
                  Text(" Johndoe@gmail.com",style: Theme.of(context).textTheme.titleLarge,),
                  SizedBox(
