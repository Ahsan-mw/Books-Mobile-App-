...
class AppTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    bodyLarge: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.bold, color: AppColors.dark),
    bodyMedium: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.normal, color: AppColors.dark),
    bodySmall: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.w700, color: AppColors.dark.withOpacity(0.5)),
